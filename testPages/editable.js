$(document).ready(function() {
    $('#editableTable').SetEditable({
        ...
        onEdit: function(columnsEd) {
            var CashTime = columnsEd[0].childNodes[1].innerHTML;
            ...
            $.ajax({
                ...
                url: "action.php",
                dataType: "json",
                data: { cash_Timestamp: CashTime, name: empName, gender: gender, age: age, skills: skills, address: address, action: 'edit' },
