...
$sql = "SELECT c.cash_Id,c.cash_Value,c.cash_Descr, c.type_Id,c.usr_Id
FROM allcash c
INNER JOIN users u ON c.usr_Id = u.usr_Id
WHERE c.usr_Id = 2 AND c.type_Id ='3'";
...
$SUMsql = "SELECT SUM(cash_Value) AS ValSum FROM allcash WHERE usr_id = '2' AND type_Id ='3' "; 
