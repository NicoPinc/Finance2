...
<!--
      <li class="nav-item disabled">
        <a class="nav-link" href="?page=newEarn" method="post" >New Earning  <span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item disabled">
        <a class="nav-link" href="?page=newFund" method="post">New Expense <span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item active">
        <a class="nav-link" href="?page=testing" method="post">Testing <span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item active">
        <a class="nav-link" href="?page=newrec" method="post">Testing new record <span class="sr-only">(current)</span></a>
      </li>
      </li>
      <li class="nav-item active">
        <a class="nav-link" href="?page=edTable" method="post">Testing editable table <span class="sr-only">(current)</span></a>
      </li>
-->
    </ul>
